...
This project harvests scholarly metadata from the OpenAlex API and transforms it into concise, visually oriented research reports that support:

- Library outreach  
- Research visibility analysis  
- Local assessment  

The workflow is discipline-agnostic and can be adapted for departments, schools, or entire institutions.
...
1. Compile a researcher roster  
2. Match researchers to OpenAlex author IDs  
3. Query the OpenAlex API  
4. Build publication datasets  
5. De-duplicate records for unit-level reporting  
6. Generate bibliometric indicators  
7. Render HTML reports  
...
1. Add your `author_ids.csv` file to the `data/` directory  
2. Open the Jupyter notebook  
3. Update configuration variables (department, year range, etc.)  
4. Run all cells  
5. Review outputs in `data/`, `imgs/`, `html/`, and exported PDFs  
...
This project demonstrates how open bibliometric data and reproducible computational workflows can be used to generate scalable, faculty-facing research reports that support library engagement and research visibility.
